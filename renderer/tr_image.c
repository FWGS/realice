...
===============
*/
void Upload32( unsigned *data, int width, int height, qboolean mipmap, qboolean picmip, qboolean lightMap,
	qboolean force32bit, qboolean has_alpha, int *format, int *pUploadWidth, int *pUploadHeight )
{
...
image_t *R_CreateImage( const char *name, const byte *pic, int width, int height, 
	qboolean mipmap, qboolean allowPicmip, qboolean force32bit, int has_alpha, int glWrapClampMode )
{
	image_t  *image;
